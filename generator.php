...
<html lang="en">
<head>
	<title>SPB Button Generator - Fixed amount</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="jumbotron2 text-center">
	  <!-- PayPal Logo --><table border="0" cellpadding="10" cellspacing="0" align="center"><tr><td align="center"></td></tr><tr><td align="center"><a href="https://www.paypal.com/uk/webapps/mpp/paypal-popup" title="How PayPal Works" onclick="javascript:window.open('https://www.paypal.com/uk/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;"> <img src="https://www.paypalobjects.com/webstatic/mktg/Logo/pp-logo-100px.png" border="0" alt="PayPal Logo"></a></td><td><div class="title">SPB Button Generator - Fixed amount</div></td> <td><a href="index.php" style="color:#FFF;">Go to Home</a></td></tr></table><!-- PayPal Logo -->
	</div>
	...
	<div class="container-fluid">
		<div class="row jumbotron">
			<div class="col-md-3">
				<form method="post" action="">
					...
					<!-- <div class="form-group">
						...
						<select name="label" id="label" class="form-control formElemComm">
			...
			<div class="col-md-4">
				<div id="segment"></div>
				<div class="col-md-11"><button name="addMore" class="btn btn-primary center-block" id="addMore">Generate New Button</button></div>
			</div>
		</div><br/>
	</div>
