...
<body>
	...
	<div class="jumbotron2 text-center">
	  <!-- PayPal Logo --><table border="0" cellpadding="10" cellspacing="0" align="center"><tr><td align="center"></td></tr><tr><td align="center"><a href="https://www.paypal.com/uk/webapps/mpp/paypal-popup" title="How PayPal Works" onclick="javascript:window.open('https://www.paypal.com/uk/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;"> <img src="https://www.paypalobjects.com/webstatic/mktg/Logo/pp-logo-100px.png" border="0" alt="PayPal Logo"></a></td><td><div class="title">SPB Button Generator - Variable Amount</div></td><td><a href="index.php" style="color:#FFF;">Go to Home</a></td></tr></table><!-- PayPal Logo -->
	</div>
	...
	<div class="container-fluid">
		<div class="row jumbotron">
			...
			<div class="col-md-4">
				<div id="segment2"><div class="container-fluid"><form method="post" action=""><div class="row row1 jumbotron"><div class="col-sm-12"><input type="hidden" name="segment" value="1"><div class="form-group">
					<span for="name"> <input type="text" name ="nameLabel" id="nameLabel" class="formElemNameLabel" value="Enter Description(you can modify this label)" style="border:0px; width:100%">  </span>
						<input type="text" name="name1" id="name1" class="form-control formElemNameLabel" autocomplete="off" required="required" value="Sample product"></div></div><div class="col-sm-12"><div class="form-group">
					<span for="price"><input type="text" name="priceLabel" class="formElemNameLabel" id="priceLabel" value="Enter Amount(you can modify this label)" style="border:0px; width:100%; ">  </span>
						<input type="number" step="0.01" name="price1" id="price1" value="2.00" class="form-control formElemNameLabel"></div></div>

						<div class="pull-left" id="dispBtn1"><div id="paypal-button-1"></div></div>

						<div class="col-sm-12">
					<pre id="prettyprint1" class="col-sm-8 prettyprint" style="width:100%"></pre>
					<a class="col-sm-3 copy-text btn btn-warning pull-right" data-clipboard-target="#prettyprint1">Copy</a></div><div class="col-sm-12" style="float:right; margin-top:10px;"></div></div></form></div></div>
			</div>
		</div><br/>
	</div>
